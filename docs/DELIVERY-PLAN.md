...
| 5 | Self-contained `aegismesh demo` | 2, 4 | Loopback-only synthetic HTTP/TCP/MCP/SSH flow, OS-assigned ports, bounded readiness and cleanup scope, deterministic human and JSON summaries, integrity-verified evidence | PASS — local gates, independent review and PR #52 CI; merge pending |
