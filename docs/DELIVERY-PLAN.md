...
| 7 | Extension live-policy boundary | 4 | ADR resolves the boundary; shipped path remains typed, bounded, evidence-linked and non-enforcing; no execution/path/config mutation; no new signal egress without approval | IN PROGRESS — implementation and focused race tests pass; full gates pending |
